...
validate_recipe_outputs "ldas-tools-diskcacheapi-swig-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="ldas-tools-diskcacheapi-swig-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi